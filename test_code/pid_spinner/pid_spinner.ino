...
#define DISTANCE_PIN 30 // distnace sensor pin
...
void setup() {
  ...
  pinMode(S_ENB, OUTPUT); pinMode(S_IN3, OUTPUT); pinMode(S_IN4, OUTPUT);
  ...
  //sample motor functions for top/spinner servos
...
int count = 0;
void loop() {
  //int state = digitalRead(DISTANCE_PIN);
